...
- [x] P2.9 专家能力校准与中断恢复：全 35 个专家能力单元等额 case；独立 worker 单任务硬预算；case 原子检查点、identity、partial 报告和同命令续跑。（2026-08-27 完成：105 case 计划覆盖 30 普通+5 S9 单元；中断保留/恢复、失败继续、身份拒绝、硬超时和真实 worker 成功路径测试通过）
